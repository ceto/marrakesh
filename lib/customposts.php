...
function marrakesh_custom_post_type() {
    ...
    $labels = array(
        ...
        'menu_name'             => __( 'Works & Galleries', 'marrakesh' ),
        ...
        'add_new'               => __( 'Add New Reference', 'marrakesh' ),
    ...
    // helper galleries
    $labels = array(
        'name'                  => _x( 'Galleries', 'Post Type General Name', 'marrakesh' ),
        'singular_name'         => _x( 'Gallery', 'Post Type Singular Name', 'marrakesh' ),
        'menu_name'             => __( 'Gallery', 'marrakesh' ),
        'name_admin_bar'        => __( 'Gallery', 'marrakesh' ),
        'archives'              => __( 'Item Archives', 'marrakesh' ),
        'attributes'            => __( 'Item Attributes', 'marrakesh' ),
        'parent_item_colon'     => __( 'Parent Item:', 'marrakesh' ),
        'all_items'             => __( 'Galleries', 'marrakesh' ),
        'add_new_item'          => __( 'Add New Item', 'marrakesh' ),
        'add_new'               => __( 'Add New Gallery', 'marrakesh' ),
        'new_item'              => __( 'New Item', 'marrakesh' ),
        'edit_item'             => __( 'Edit Item', 'marrakesh' ),
        'update_item'           => __( 'Update Item', 'marrakesh' ),
        'view_item'             => __( 'View Gallery', 'marrakesh' ),
        'view_items'            => __( 'View Galleries', 'marrakesh' ),
        'search_items'          => __( 'Search Gallery', 'marrakesh' ),
        'not_found'             => __( 'Not found', 'marrakesh' ),
        'not_found_in_trash'    => __( 'Not found in Trash', 'marrakesh' ),
        'featured_image'        => __( 'Featured Image', 'marrakesh' ),
        'set_featured_image'    => __( 'Set featured image', 'marrakesh' ),
