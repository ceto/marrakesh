...
gulp.task('generatepot', function() {
    return gulp
        ...
        .pipe(
            wpPot({
                domain: 'marrakesh',
                package: 'Marrakesh Global Theme'
            })
        )
        .pipe(gulp.dest('lang/marrakesh.pot'));
});
...
// ### Gulpicon and SVG font reference build
// var iconfiles = glob.sync('assets/icons/*.svg');
// gulp.task('gulpicon', gulpicon(iconfiles, {
//     previewTemplate: 'assets/icons/tmpl/preview.hbs',
...
gulp.task(
    'build',
    gulp.series('styles', 'scripts', gulp.parallel('svgicons',  'fonts', 'images', 'generatepot' ))
);
...
gulp.task('watch', gulp.series('default', function() {
    ...
    gulp.watch([path.source + 'icons/*.svg'], gulp.series('svgicons'));
    // gulp.watch(['**/*.php'], gulp.series('generatepot'));
