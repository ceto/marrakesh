        ...
        for (var i = 0; i < numNodes; i++) {
            ...
            if (articleEl.querySelectorAll(".referencecard__quickinfo").length > 0) {
                item.title =
                    ...
                    caption +
                    "<small>" +
                    articleEl.querySelectorAll(".referencecard__quickinfo")[0].textContent +
                    "</small></h3>";
            } else {
            ...
            shareButtons: [
                {
                    ...
                    url:
                        ...
                        items[index].el.getElementsByTagName("a")[0].getAttribute("href")
                },
                {
                    id: "twitter",
                    label: "Tweet",
                    url:
                        ...
                        items[index].el.querySelectorAll(".referencecard__title")[0]
...
initPhotoSwipeFromWorksDOM(".referenceswipe");
    ...
    if ($(".menu--portfolio").hasClass("js-activate-filter")) {
        ...
        if (pathArray.length === 4) {
            window.location.href =
                brick_globals.portfoliourl + "#" + pathArray[1] + "=" + pathArray[2];
        } else {
