...
<div class="yith-wcwl-share">
    ...
    <ul class="menu menu--footersocial">
        <li><a target="_blank" rel="noopener" href="mailto:?subject=<?php echo esc_attr( apply_filters( 'yith_wcwl_email_share_subject', $share_link_title ) ); ?>&amp;body=<?php echo esc_attr( apply_filters( 'yith_wcwl_email_share_body', urlencode( $share_link_url ) ) ); ?>&amp;title=<?php echo esc_attr( $share_link_title ); ?>" title="<?php esc_html_e( 'Email', 'yith-woocommerce-wishlist' ); ?>"><?= svginsert('envelope', 'icon'); ?></a></li>
        <li><a target="_blank" rel="noopener" href="https://www.facebook.com/sharer.php?u=<?php echo urlencode( $share_link_url ); ?>&p[title]=<?php echo esc_attr( $share_link_title ); ?>" title="<?php esc_html_e( 'Facebook', 'yith-woocommerce-wishlist' ); ?>"><?= svginsert('facebook', 'icon'); ?></a></li>
        <li><a target="_blank" rel="noopener" href="<?php echo esc_attr( $share_whatsapp_url ); ?>" data-action="share/whatsapp/share" target="_blank" rel="noopener" title="<?php esc_html_e( 'WhatsApp', 'yith-woocommerce-wishlist' ); ?>"><?= svginsert('whatsapp', 'icon'); ?></a></li>
        <!-- <li><a target="_blank" rel="noopener" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode( $share_link_url ); ?>&amp;description=<?php echo esc_attr( $share_summary ); ?>&amp;media=<?php echo esc_attr( $share_image_url ); ?>" title="<?php esc_html_e( 'Pinterest', 'yith-woocommerce-wishlist' ); ?>"><?= svginsert('pinterest2', 'icon'); ?></a></li> -->
        <!-- <li><a target="_blank" rel="noopener" href="https://twitter.com/share?url=<?php echo urlencode( $share_link_url ); ?>&amp;text=<?php echo esc_attr( $share_twitter_summary ); ?>" title="<?php esc_html_e( 'Twitter', 'yith-woocommerce-wishlist' ); ?>"><?= svginsert('twitter', 'icon'); ?></a></li> -->
    </ul>
    <br>
